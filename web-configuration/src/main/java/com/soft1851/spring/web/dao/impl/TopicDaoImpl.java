...
public class TopicDaoImpl implements TopicDao {
    ...
    public int[] batchInsert(List<Topic> topics) {
        ...
        String sql = "INSERT INTO t_topic(id,topic_name,topic_icon,descripion,followers_count,msg_count,followed)" +
                "VALUES(?,?,?,?,?,?,?)";
        return jdbcTemplate.batchUpdate(sql, new BatchPreparedStatementSetter() {
            ...
            public void setValues(PreparedStatement preparedStatement, int i) throws SQLException {
                ...
                preparedStatement.setInt(6,topic.getFollowerCount());
    ...
    public int insert(Topic topic) {
        String sql = "INSERT INTO t_topic(id,topic_name,topic_icon,descripion,followers_count,msg_count,followed)" +
                "VALUES(?,?,?,?,?,?,?)";
        Object[] params = {topic.getId(),topic.getTopicName(),topic.getTopicIcon(),topic.getDescription(),topic.getMsgCount(),topic.getFollowerCount(),topic.getFollowed()};
